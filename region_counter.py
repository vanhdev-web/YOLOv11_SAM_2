...
if __name__ == '__main__':
    ...
    region_points = {
        "region-01": [[614, 321], [676, 346], [7, 825], [3, 648]],
        "region-02": [[679, 347], [726, 381], [158, 998], [14, 827]],
        "region-03": [[732, 379], [830, 403], [577, 1011], [167, 998]],
        "region-04":[[1203, 929], [992, 346], [1068, 340], [1462, 864]],
        "region-05": [[1066, 336], [1120, 323], [1709, 810], [1471, 862]],
        "region-06": [[1123, 321], [1174, 316], [1844, 724], [1712, 806]],
    }

    # Video writer
    w, h, fps = (int(cap.get(x)) for x in (cv2.CAP_PROP_FRAME_WIDTH, cv2.CAP_PROP_FRAME_HEIGHT, cv2.CAP_PROP_FPS))
    video_writer = cv2.VideoWriter("out.mp4", cv2.VideoWriter_fourcc(*"mp4v"), fps, (w, h))
